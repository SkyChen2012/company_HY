...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Datalist.setGeometry(QtCore.QRect(10, 100, 601, 161))
        self.Datalist.setObjectName("Datalist")
        self.Datalist.setColumnCount(5)
        ...
        self.ShowData = QtWidgets.QTextEdit(self.centralwidget)
        self.ShowData.setGeometry(QtCore.QRect(10, 300, 601, 181))
